...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form action="/college/new_attendance" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    <input name="grade${i}" type="radio" value="0">
                                                    缺勤
                                                </label>
                                                <label>
                                                    <input name="grade${i}" type="radio" value="1">
                                                    迟到
                                                </label>
                                                <label>
                                                    <input name="grade${i}" type="radio" value="2">
                                                    早退
                                                </label>
                                                <label>
                                                    <input name="grade${i}" type="radio" value="3" checked>
                                                    出勤
                                                </label>
                                            </div>
                                        </td>
